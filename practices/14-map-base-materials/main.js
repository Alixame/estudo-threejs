...
const wood = new THREE.MeshStandardMaterial({
    map: new THREE.TextureLoader().load('https://gbaptista.s3-sa-east-1.amazonaws.com/threejs/wood/basecolor.jpg'),
    normalMap: new THREE.TextureLoader().load('https://gbaptista.s3-sa-east-1.amazonaws.com/threejs/wood/normal.jpg'),
})
